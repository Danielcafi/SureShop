...
import { Users, Award, Target, Heart, Globe, Shield, Truck, Headphones } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About ShopPro</h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Your trusted online shopping destination with over 1 million products and excellent customer service.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2020, ShopPro started as a small team with a big dream: to make online shopping 
                accessible, convenient, and enjoyable for everyone. What began as a local e-commerce platform 
                has grown into a global marketplace serving millions of customers worldwide.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                We believe that shopping should be more than just a transaction – it should be an experience. 
                That's why we've built our platform with cutting-edge technology, user-friendly design, and 
                a commitment to customer satisfaction that's second to none.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're committed to revolutionizing the way people shop online through innovation, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Connecting people and products across the world seamlessly.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The passionate people behind ShopPro who work tirelessly to make your shopping experience exceptional.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm mt-2">
                Tech expert driving our platform's scalability and performance.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-600 font-medium">Chief Marketing Officer</p>
              <p className="text-gray-600 text-sm mt-2">
                Creative strategist building our brand and customer relationships.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Why Choose ShopPro?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're not just another e-commerce platform – we're your shopping partner.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Free shipping on orders over $50 with same-day delivery in major cities.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Bank-level encryption and fraud protection for all transactions.
              </p>
            </div>
